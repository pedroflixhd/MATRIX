...
nome_contador = "PEDROFLIX"
link_contador = "https://whos.amung.us/pingjs/"    


##CONFIGURAÇÕES
####  TITULO DO MENU  #################################################################
title_menu = "[B][COLOR white]||||||| PEDROFLIX |||||||[/COLOR][/B]"
###  DESCRIÇÃO DO ADDON ###############################################################
title_descricao = "O melhor conteudo na melhor qualidade."
...
url_origem = 'https://pastebin.com/raw/JXTaYvfh'
try:
...
def init_SKindex(msg):
   ...
   if status_mensagem1 == 'true':
    dialog = xbmcgui.Dialog()
    link = dialog.select("[B]BEM-VINDOS AO [COLOR white]PEDROFLIX[/COLOR][/B]", [
    "[B][COLOR white]Facebook [/COLOR] [/B]",
    "[B][COLOR white]Instagram[/COLOR] [/B]",
    "[B][COLOR white]Whatsapp[/COLOR] [/B]",
    "[B][COLOR white]ENTRAR NO ADD-ON [/COLOR] [/B]"])    
      
    if link == 0:
     if xbmc . getCondVisibility ( 'system.platform.android' ) :
         xbmc . executebuiltin ( 'StartAndroidActivity(,android.intent.action.VIEW,,%s)' % ( 'https://www.facebook.com/profile.php?id=100072538094588' ) )
     else:
        ost = webbrowser . open ( 'https://www.facebook.com/profile.php?id=100072538094588' )
